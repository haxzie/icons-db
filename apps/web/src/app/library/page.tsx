...
export default function LibraryPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[1600px] flex-1 px-4 py-8">
      <h1 className="text-2xl font-semibold tracking-tight">Icon sets</h1>
      ...
      <div className="mt-6 overflow-hidden rounded-xl border bg-bg-elevated">
        <table className="w-full text-sm">
          ...
          <tbody>
            {collections.map((c) => (
              <tr key={c.prefix} className="border-t hover:bg-bg">
