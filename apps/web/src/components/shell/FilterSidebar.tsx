...
export function FilterSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`scrollbar-thin fixed inset-y-0 left-0 z-40 w-[320px] overflow-y-auto bg-panel transition-transform md:sticky md:top-0 md:z-0 md:h-screen md:shrink-0 md:transition-[width,transform] ${
      ...
      >
        <div className="w-[320px] px-5 pb-10 pt-4">
          <div className="mb-2 flex h-10 items-center justify-end gap-1">
            <button type="button" onClick={onReset} className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm text-fg-muted hover:bg-black/5 hover:text-fg dark:hover:bg-white/5">
            ...
            <button type="button" onClick={onClose} aria-label="Close filters" className="grid size-9 place-items-center rounded-full text-fg-muted hover:bg-black/5 hover:text-fg dark:hover:bg-white/5">
  ...
  return (
    <section className="border-t py-3">
      <button
        ...
        className="flex w-full items-center gap-3 rounded-lg px-1 py-2 text-left text-[15px] font-medium hover:bg-black/5 dark:hover:bg-white/5"
      >
