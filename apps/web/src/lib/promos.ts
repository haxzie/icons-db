...
export const PROMOS: Promo[] = [
  ...
  { id: "mcp", title: "MCP for coding agents", tagline: "Claude Code, Cursor & Codex search icons by intent", href: "/docs/mcp", icon: "lucide:bot" },
  { id: "api", title: "IconsDB API", tagline: "Search & render icons from your app", href: "/api", icon: "lucide:webhook" },
